...
<body>
		...
		<c:forEach items="${simulado.questoes}" var="questao">
			<p>
				...
				<c:forEach items="${questao.alternativas}" var="alternativa">
					<input type="radio" name="questao_${questao.codQuestao}"
						value="${alternativa.id}"
						id="${questao.codQuestao}-${alternativa.id}" />
	...
	<br/>
	<br/>
	Tempo Gasto: ${simulado.tempo}
	Tempo Pontuacao: ${simulado.pontos}
	Tempo Acertos: ${simulado.acertos}
